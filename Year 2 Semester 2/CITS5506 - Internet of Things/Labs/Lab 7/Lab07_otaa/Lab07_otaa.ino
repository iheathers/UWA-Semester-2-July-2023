...
static const u1_t PROGMEM DEVEUI[8]={ 0x62, 0x58, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// This key should be in big endian format (or, since it is not really a
// number but a block of memory, endianness does not really apply). In
// practice, a key taken from ttnctl can be copied as-is.
static const u1_t PROGMEM APPKEY[16] = { 0x66, 0xD9, 0xFD, 0xEB, 0x41, 0x8A, 0x91, 0x5F, 0x79, 0x08, 0x63, 0xE9, 0x8F, 0xD4, 0xA1, 0x44 };
...
//              Serial.print("dataBeg :"); Serial.println(LMIC.dataBeg);
        ...
        */
        case EV_TXSTART:
            Serial.println(F("LoRa Packet transmission start"));
            break;
        case EV_TXCANCELED:
